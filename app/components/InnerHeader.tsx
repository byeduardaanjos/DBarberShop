...
export default function InnerHeader() {
  ...
  return <header className="site-header inner-site-header">
    ...
    <nav className={open ? "nav open" : "nav"}><a href="/servicos">Serviços</a><a href="/trabalhos">Trabalhos</a><a href="/#sobre">Sobre</a><a href="/#contato">Contato</a><a className="nav-book" href="/?agendar=1">Agendar horário</a></nav>
