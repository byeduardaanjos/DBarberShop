...
export default function Home() {
  ...
  return <main>
    ...
    <section className="work" id="trabalhos"><div className="gallery-coming-soon"><p className="eyebrow">TRABALHOS D.BARBERSHOP</p><span className="gallery-line"/><h2>Novos trabalhos<br/>em breve.</h2><p>A galeria receberá os primeiros cortes, barbas e acabamentos realizados na D.BarberShop.</p><a className="outline-cta icon-link" href="/trabalhos"><span>Conhecer a galeria</span><ArrowRight/></a></div></section>
