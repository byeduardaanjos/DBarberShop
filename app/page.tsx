...
const services = [
  { name: "Degradê", detail: "Transição precisa e acabamento alinhado.", time: "60 min", price: "R$ 35", priceCents: 3500, image: "/images/imperium-hero-v3.webp" },
  { name: "Degradê Navalhado", detail: "Degradê rente com acabamento navalhado.", time: "60 min", price: "R$ 40", priceCents: 4000, image: "/images/imperium-barba-v3.webp" },
  { name: "Sobrancelha", detail: "Limpeza e alinhamento para um visual cuidado.", time: "60 min", price: "R$ 10", priceCents: 1000, image: "/images/imperium-ambiente-v3.webp" },
  ...
  { name: "Corte na Tesoura", detail: "Corte clássico feito inteiramente na tesoura.", time: "60 min", price: "R$ 35", priceCents: 3500, image: "/images/imperium-hero-v3.webp" },
];
...
export default function Home() {
  ...
  function saveToCalendar() {
    ...
    const calendar = [
      ...
      `SUMMARY:${confirmedBooking.services.join(" + ")} - D.BarberShop`,
