...
and p_time in('09:00'::time,'10:00'::time,'11:00'::time,'12:00'::time,'13:00'::time,'14:00'::time,'15:00'::time,'16:00'::time,'17:00'::time,'18:00'::time,'19:00'::time)
and ((extract(hour from p_time)::integer*60)+extract(minute from p_time)::integer+p_duration)<=case when extract(dow from p_date)=6 then 1080 else 1200 end
...
with service as(select duration_minutes from public.services where name=p_service_name and active=true),slots(booking_time) as(values('09:00'::time),('10:00'::time),('11:00'::time),('12:00'::time),('13:00'::time),('14:00'::time),('15:00'::time),('16:00'::time),('17:00'::time),('18:00'::time),('19:00'::time))
